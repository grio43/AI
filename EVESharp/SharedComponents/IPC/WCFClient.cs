...
{
    /// <summary>
    ///     Description of InjectorWCFClient.
    /// </summary>
    public class WCFClient
    {
        ...
        public void SetCallBackService(IDuplexServiceCallback serviceCallback, string _GUID)
        {
        ...
        private void CreateChannel()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(GUID))
                    pipeProxy.AttachCallbackHandlerToEveAccount(GUID);
