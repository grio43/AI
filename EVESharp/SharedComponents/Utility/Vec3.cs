...
namespace SharedComponents.Utility
{
        ...
        : IComparable, IComparable<Vec3>, IEquatable<Vec3>, IFormattable
    {
        ...
        private static Vec3 NormalizeSpecialCasesOrOrigional(Vec3 v1)
        {
            if (double.IsInfinity(v1.Magnitude))
            {
                var _x = v1.X == 0 ? 0 : v1.X == -0 ? -0 : double.IsPositiveInfinity(v1.X) ? 1 : double.IsNegativeInfinity(v1.X) ? -1 : double.NaN;
                var _y = v1.Y == 0 ? 0 : v1.Y == -0 ? -0 : double.IsPositiveInfinity(v1.Y) ? 1 : double.IsNegativeInfinity(v1.Y) ? -1 : double.NaN;
                var _z = v1.Z == 0 ? 0 : v1.Z == -0 ? -0 : double.IsPositiveInfinity(v1.Z) ? 1 : double.IsNegativeInfinity(v1.Z) ? -1 : double.NaN;
        ...
        {
            double _x = v1.X;
            double _y = (v1.Y * Math.Cos(rad)) - (v1.Z * Math.Sin(rad));
            double _z = (v1.Y * Math.Sin(rad)) + (v1.Z * Math.Cos(rad));
            return new Vec3(_x, _y, _z);
        }
        ...
        {
            double _x = (v1.Z * Math.Sin(rad)) + (v1.X * Math.Cos(rad));
            double _y = v1.Y;
            double _z = (v1.Z * Math.Cos(rad)) - (v1.X * Math.Sin(rad));
            return new Vec3(_x, _y, _z);
        }
        ...
        {
            double _x = (v1.X * Math.Cos(rad)) - (v1.Y * Math.Sin(rad));
            double _y = (v1.X * Math.Sin(rad)) + (v1.Y * Math.Cos(rad));
            double _z = v1.Z;
            return new Vec3(_x, _y, _z);
        }
        ...
        {
            double _x = v1.X;
            double _y = (v1.Y * Math.Cos(rad)) - (v1.Z * Math.Sin(rad)) + (yOff * (1 - Math.Cos(rad)) + zOff * Math.Sin(rad));
            double _z = (v1.Y * Math.Sin(rad)) + (v1.Z * Math.Cos(rad)) + (zOff * (1 - Math.Cos(rad)) - yOff * Math.Sin(rad));
            return new Vec3(_x, _y, _z);
        }
        ...
        {
            double _x = (v1.Z * Math.Sin(rad)) + (v1.X * Math.Cos(rad)) + (xOff * (1 - Math.Cos(rad)) - zOff * Math.Sin(rad));
            double _y = v1.Y;
            double _z = (v1.Z * Math.Cos(rad)) - (v1.X * Math.Sin(rad)) + (zOff * (1 - Math.Cos(rad)) + xOff * Math.Sin(rad));
            return new Vec3(_x, _y, _z);
        }
        ...
        {
            double _x = (v1.X * Math.Cos(rad)) - (v1.Y * Math.Sin(rad)) + (xOff * (1 - Math.Cos(rad)) + yOff * Math.Sin(rad));
            double _y = (v1.X * Math.Sin(rad)) + (v1.Y * Math.Cos(rad)) + (yOff * (1 - Math.Cos(rad)) - xOff * Math.Sin(rad));
            double _z = v1.Z;
            return new Vec3(_x, _y, _z);
        }
