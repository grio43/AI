...
namespace SharedComponents.Socks5.Socks
{
    internal class SocksSpecialTunnel
    {
        ...
        private readonly int PacketSize = 4096;

        private readonly List<DataHandler> Plugins = new List<DataHandler>();
        public Client RemoteClient;
        public SocksRequest Req;
        private readonly SocksEncryption se;
        ...
        public void Open(IPAddress outboundIP)
        {
            ...
            SocketAsyncEventArgs socketArgs = new SocketAsyncEventArgs { RemoteEndPoint = new IPEndPoint(ModifiedReq.IP, ModifiedReq.Port) };
        ...
        private void socketArgs_Completed(object sender, SocketAsyncEventArgs e)
        {
            ...
            {
                Console.WriteLine("Error while connecting: {0}", e.SocketError);
