...
namespace SharedComponents.Socks5.Encryption
{
    public class SocksEncryption
    {
        ...
        private DarthEncryptSocks5 dc;
        private DarthEncryptSocks5 dcc;
        ...
        public void GenerateKeys()
        {
            ...
            dc = new DarthEncryptSocks5();
            dc.PassPhrase = Utils.RandStr(20);
            dcc = new DarthEncryptSocks5();
        }
            ...
            try
            {
                ...
                switch (auth)
                {
                    case AuthTypes.SocksBoth:
                        ...
                        byte[] data = dcc.DecryptBytes(buff);
