...
namespace SharedComponents.Socks5.Encryption
{
    public class DarthEncryptSocks5
    {
        #region Constructors

        public DarthEncryptSocks5()
        {
            InitializeComponent();
            if (PassPhrase == null)
        ...
        public byte[] DecryptBytes(byte[] encryptedBytes)
        {
            ...
            if (HashType == DCHashTypes._SHA1)
                strHashName = "SHA1";
            if (HashType == DCHashTypes._SHA256)
                strHashName = "SHA256";
            if (HashType == DCHashTypes._SHA384)
                strHashName = "SHA384";
            if (HashType == DCHashTypes._SHA512)
                strHashName = "SHA512";
        ...
        {
            DoTransformFile(inFile, TransformType._decrypt, null, null);
        }
        ...
        {
            DoTransformFile(inFile, TransformType._decrypt, outFileName, null);
        }
        ...
        {
            DoTransformFile(inFile, TransformType._decrypt, outFileName, outDirectory);
        }
        ...
        {
            DoTransformFile(inFile, TransformType._encrypt, null, null);
        }
        ...
        {
            DoTransformFile(inFile, TransformType._encrypt, outFileName, null);
        }
        ...
        {
            DoTransformFile(inFile, TransformType._encrypt, outFileName, outDirectory);
        }
