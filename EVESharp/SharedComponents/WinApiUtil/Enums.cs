...
namespace SharedComponents.WinApiUtil
{
    ...
    public enum WM : uint
    {
        ...
        /// <summary>
        ///     The WM_APP constant is used by applications to help define public messages, usually of the form WM_APP+X, where X
        ///     is an integer value.
        /// </summary>
        APP = 0x8000,

        /// <summary>
        ///     The WM_USER constant is used by applications to help define public messages for use by public window classes,
