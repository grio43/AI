...
namespace SharedComponents.EVE
{
    ...
    public class HWSettings : ViewModelBase
    {
        ...
        public void CleanupAllEveLogsForThisWindowsUserProfile()
        {
            //string eveChatLogsDirectoryPath = eveLogDirectoryPath + "\\" + "ChatLogs";
            //string eveFleetLogsDirectoryPath = eveLogDirectoryPath + "\\" + "FleetLogs";
            //string eveGameLogsDirectoryPath = eveLogDirectoryPath + "\\" + "GameLogs";
            //string eveMarketLogsDirectoryPath = eveLogDirectoryPath + "\\" + "MarketLogs";
            if (Util.IntervalInMinutes(180, 180, WindowsUserLogin))
            {
                CleanupSpecificEveLogsForThisWindowsUserProfile("GameLogs");
                CleanupSpecificEveLogsForThisWindowsUserProfile("FleetLogs");
                CleanupSpecificEveLogsForThisWindowsUserProfile("ChatLogs");
                CleanupSpecificEveLogsForThisWindowsUserProfile("MarketLogs");
            }
        }

        public void CleanupSpecificEveLogsForThisWindowsUserProfile(string LogSubFolder = "GameLogs")
        {
        ...
        public bool HWSettingsAreProperlyDefined
        {
            get
            {
                if (Proxy == null)
                ...
                if (string.IsNullOrEmpty(GpuManufacturer) || GpuDriverDate == DateTime.MinValue)
                {
