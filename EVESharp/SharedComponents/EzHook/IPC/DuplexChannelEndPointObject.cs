...
namespace EasyHook.IPC
{
    ...
    internal abstract class DuplexChannelEndPointObject : EndPointObject
    {
        ...
        /// <summary>
        ///     Reads, using reflection on <paramref name="derivingType" />, whether the remote endpoint is ready to be connected
        ///     to.
        /// </summary>
        ...
        /// <summary>
        ///     Subscribes, using reflection on <paramref name="derivingType" />, to an event raised when the remote endpoint
        ///     signals its ready status.
        /// </summary>
        /// <param name="derivingType"></param>
        ...
        ///     <see cref="DuplexChannelEndPointObject" />.
        /// </summary>
        ...
        /// </summary>
        protected internal static bool IsRemoteEndPointReady => _isEndPointReady;
        ...
        /// <param name="onActivated"></param>
        /// <param name="state"></param>
        protected internal static void Subscribe(EventHandler onActivated, object state)
        {
