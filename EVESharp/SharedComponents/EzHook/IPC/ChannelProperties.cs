...
namespace EasyHook.IPC
{
    ...
    internal struct ChannelProperties
    {
        ...
        /// <summary>
        ///     Gets whether or not the current <see cref="ChannelProperties" /> describes the outgoing channel of the
        ///     instantiating endpoint.
        /// </summary>
        public bool IsInstantiatorChannel => _localEndPointIsInstantiator;
        ...
        ///     An <see cref="ArgumentException" /> is thrown if the given <paramref name="value" /> contains any of the following
        ///     values:
        ///     "_I", "_R" or "/"
        /// </exception>
        ...
        /// </summary>
        public string Url => ChannelName != null && EndPointName != null
        ...
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     An <see cref="ArgumentException" /> is thrown if the given <paramref name="channelName" /> contains any of the
        ///     following values:
        ///     "_I", "_R" or "/"
        /// </exception>
