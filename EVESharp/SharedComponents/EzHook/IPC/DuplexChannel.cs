...
namespace EasyHook.IPC
{
        ...
        where TRemoteEndPoint : DuplexChannelEndPointObject
    {
        ...
        /// </summary>
        public DuplexChannelState State => _state;

        /// <summary>
        ///     Gets the full URL of the local endpoint server.
        /// </summary>
        public string LocalEndPointUrl => _localChannelProperties.Url;

        /// <summary>
        ///     Gets whether or not the local endpoint is the channel's instantiator.
        /// </summary>
        public bool IsLocalEndPointInstantiator => _localChannelProperties.IsInstantiatorChannel;
