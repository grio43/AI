...
namespace HookManager.Win32Hooks
{
    ...
    /// </summary>
    public class CreateProcessAController : IHook, IDisposable
    {
        #region Fields
        ...
        public CreateProcessAController()
        {
            Error = false;
            Name = nameof(CreateProcessAController);
        ...
        private delegate bool CreateProcessDelegate(
            [InAttribute()][MarshalAsAttribute(UnmanagedType.BStr)] string LpApplicationName,
            [InAttribute()][MarshalAsAttribute(UnmanagedType.BStr)] string lpCommandLine,
            ...
            [InAttribute()][MarshalAsAttribute(UnmanagedType.BStr)] string lpCurrentDirectory,
            [InAttribute()] ref STARTUPINFOA lpStartupInfo,
        ...
        public static string[] AllowedProcesses { get; } = new string[]
        {
            "DecompRcodeEx.exe", 
            "taskkill",
            "ffmpeg.exe",
        ...
        private bool CreateProcessDetour(
            ...
            [InAttribute()] ref PROCESS_INFORMATION lpProcessInformation)
        {
            var msg = $"CreateProcA lpApplicationName {LpApplicationName} lpCommandLine {lpCommandLine} lpCurrentDirectory {lpCurrentDirectory}";
            HookManagerImpl.Log(msg);
            Trace.WriteLine(msg);
            var commandLineLower = lpCommandLine.ToLower();
            if (AllowedProcesses.Any(commandLineLower.ContainsIgnoreCase))
            {
        ...
        {
            public uint cb;
            [MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.BStr)]
