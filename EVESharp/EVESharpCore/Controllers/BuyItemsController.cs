            ...
            switch (CurrentBuyItemsState)
            {
                ...
                case BuyItemsState.CreateBuyList:
                    ...
                    Log("Current [" + ESCache.Instance.ActiveShip.GivenName + "] Cargo [" + Math.Round(ESCache.Instance.CurrentShipsCargo.Capacity, 0) +
                        "] Used Capacity [" +
                        Math.Round(ESCache.Instance.CurrentShipsCargo.UsedCapacity, 0) + "] Free Capacity [" + Math.Round(freeCargo, 0) + "]");
                    ...
                    if (buyList != null && buyList.Count > 0)
                    {
                        ...
                        double currentShipFreeCargo = ESCache.Instance.CurrentShipsCargo.Capacity - ESCache.Instance.CurrentShipsCargo.UsedCapacity;
