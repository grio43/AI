        ...
        public static bool UseDrones
        {
            get
            {
                try
                {
                    ...
                    //
                    if (!DefaultUseDrones || (ESCache.Instance.ActiveShip != null && ESCache.Instance.ActiveShip.IsShipWithNoDroneBay)) return false;
        ...
        **/
        ...
        private static bool OnEveryDroneProcessState()
        {
            try
            {
                ...
                {
                    if (DebugConfig.DebugDrones)
                        Log.WriteLine("if (ESCache.Instance.MyShipEntity == null || ESCache.Instance.ActiveShip == null) - doing nothing");
                    ChangeDroneControllerState(DroneControllerState.Idle);
                    return false;
                }
        ...
        public static int LostDrones
        {
            get
            {
                ...
                if (drone != null)
                {
                    ...
                    return (int)Math.Floor((DroneBay.Capacity - DroneBay.UsedCapacity) / drone.Volume);
                }
