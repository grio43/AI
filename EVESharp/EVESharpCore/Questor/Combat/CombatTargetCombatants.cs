...
namespace EVESharpCore.Questor.Combat
{
    public static partial class Combat
    {
        ...
        **/
        ...
        {
            IEnumerable<EntityCache> potentialCombatTargetsToLock = PotentialCombatTargets.Where(e => e.IsReadyToTarget && !e.IsPod && (e.IsNpcCapitalEscalation || e.IsNPCBattleship || e.Name.Contains("Arithmos Tyrannos"))) //|| e.IsDecloakedTransmissionRelay))
