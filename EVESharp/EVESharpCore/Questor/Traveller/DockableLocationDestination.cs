...
namespace EVESharpCore.Questor.Traveller
{
    public class DockableLocationDestination : TravelerDestination
    {
        ...
        {
            DirectLocation dockableLocation = ESCache.Instance.DirectEve.Navigation.GetLocation(dockableLocationId);
        ...
        {
            bool arrived = PerformFinalDestinationTask(DockableLocationId);
            return arrived;
        }
        ...
        internal static bool PerformFinalDestinationTask(long dockableLocationId)
        {
            ...
            IEnumerable<EntityCache> dockableLocations = ESCache.Instance.Stations.Concat(ESCache.Instance.FreeportCitadels);

            EntityCache dockableLocation = dockableLocations.Where(e => e.Id == dockableLocationId).ToList().FirstOrDefault();
            ...
            DirectEntity dockableEntity = dockableLocation._directEntity;
