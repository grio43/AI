...
namespace EVESharpCore.Cache
{
    public class EntityCache
    {
        ...
        //ArmorResistanceEm is static and will never change across the life of the Entity
        public double ArmorResistanceEm => _directEntity.ArmorResistanceEM ?? 0;
        //ArmorResistanceExplosive is static and will never change across the life of the Entity
        public double ArmorResistanceExplosive => _directEntity.ArmorResistanceExplosive ?? 0;
        //ArmorResistanceKinetic is static and will never change across the life of the Entity
        public double ArmorResistanceKinetic => _directEntity.ArmorResistanceKinetic ?? 0;
        //ArmorResistanceThermal is static and will never change across the life of the Entity
                ...
                try
                {
                    ...
                    if (_directEntity != null && IsValid)
                    {
                        if (_isReadyToTarget == null)
                        {
                            ...
                            {
                                if (ESCache.Instance.InAbyssalDeadspace && IsAbyssalDeadspaceTriglavianBioAdaptiveCache && (Combat.MaxWeaponRange > Distance || (Drones.UseDrones && Drones.DroneControlRange > Distance)))
                                {
        ...
        **/
        ...
        public double ShieldMaxHitPoints => _directEntity.MaxShield ?? 0;
                    ...
                    if (_directEntity != null && IsValid)
                    {
                        ...
                        if (Distance < (long)Distances.HalfOfALightYearInAu)
                        {
                            if (Distance > (int)Distances.WarptoDistance)
                            {
                                ...
                                if (DebugConfig.DebugTraveler) Log.WriteLine("WarpTo: [" + Name + "].WarpTo() returned false.");
                                return false;
                            }
