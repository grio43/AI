    ...
    public class ModuleCache
    {
        ...
        public bool IsReadyToReloadAmmo
        {
            get
            {
                ...
                if (_module.IsMaster || ESCache.Instance.Weapons.All(x => !x._module.IsMaster))
                    return true;
        ...
        public bool IsModuleTooDamagedToOverloadAgain
        {
            get
            {
                try
                {
                    ...
                    if (DamagePercent > 75)
                    {
                        if (DebugConfig.DebugOverLoadWeapons) Log.WriteLine("IsModuleTooDamagedToOverloadAgain: [" + TypeName + "] IsShieldRepairModule [" + IsShieldRepairModule + "] IsArmorRepairModule [" + IsArmorRepairModule + "] DamagePercent [" + DamagePercent + "] lessthan  GlobalRepsOverloadDamageAllowed [" + Defense.GlobalRepsOverloadDamageAllowed + "] return true");
                        return true;
                    }

                    if (DebugConfig.DebugOverLoadWeapons) Log.WriteLine("IsModuleTooDamagedToOverloadAgain: [" + TypeName + "] IsShieldRepairModule [" + IsShieldRepairModule + "] IsArmorRepairModule [" + IsArmorRepairModule + "] DamagePercent [" + DamagePercent + "] lessthan  GlobalRepsOverloadDamageAllowed [" + Defense.GlobalRepsOverloadDamageAllowed + "] return false");
                    return false;
                }
                catch (Exception ex)
                {
