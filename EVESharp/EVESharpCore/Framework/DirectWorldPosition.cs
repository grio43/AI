...
namespace EVESharpCore.Framework
{
    public class DirectWorldPosition
    {
        ...
        public bool Orbit(double radius, bool clearDebugLines = false)
        {
            ...
            else
            {
                ...
                var p = GetRandomOrbitPath(radius, 12, false);
        ...
        public List<DirectWorldPosition> GetRandomOrbitPath(double radius, int numPoints, bool humanize = true)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < numPoints; i++)
                {
                    double angle = i * angleIncrement;
                    Vec3 pointOnPlane = tangent * Math.Cos(angle) + bitangent * Math.Sin(angle);
                    Vec3 pointInSpace = pointOnPlane * (radius * RandomBetween(0.75d, 1.0d)) + new Vec3(XCoordinate, YCoordinate, ZCoordinate);
