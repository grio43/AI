    ...
    **/
    ...
    public class DirectSystemScanResult : DirectObject
    {
            ...
            : base(directEve)
        {
            ...
            Data = new Vec3((double)data.GetItemAt(0), (double)data.GetItemAt(1), (double)data.GetItemAt(2));
        ...
        {
            //if (corp)
            //    return DirectEve.ThreadedLocalSvcCall("bookmarkSvc", "ACLBookmarkScanResult", Id, title, comment, Id,
            ...
            //return DirectEve.ThreadedLocalSvcCall("bookmarkSvc", "ACLBookmarkScanResult", Id, WhatIsThisFolderId, title, comment, TypeID, WhatIsThisExpiry, WhatIsThisSubFolderId);
            return true;
        }
